	...
	<header id="masthead" class="site-header col-12" role="banner">
		<div class="site-branding">
			<?php if ( page_has_parent() ) : ?>
				<p class="site-title"><a href="<?php echo esc_url( get_permalink( get_page_parent() ) ); ?>" rel="bookmark"><?php echo esc_html( get_the_title( get_page_parent() ) ); ?></a></p>
			<?php else : ?>
				<p class="site-title"><?php echo esc_html( get_the_title( get_page_parent() ) ); ?></p>
			<?php endif; ?>
